...
TASK_TOOL_MAP: dict[str, list[str]] = {
    ...
    "task_07": ["get_booking","search_alternatives","rebook_flight","check_policy_compliance","flag_hotel_policy_violation","request_vp_exception","notify_traveler","cancel_booking"],
